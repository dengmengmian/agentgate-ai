...
async function renderTs(providers) {
  ...
  return prettier.format(`// Generated by scripts/generate-provider-catalog.mjs. Do not edit by hand.
...
writeOrCheck(tsOut, await renderTs(providers));
