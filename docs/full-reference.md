...
|---|---|
| 🍎 macOS — Apple Silicon (M1–M4) | [AgentGate_1.4.1_aarch64.dmg](https://github.com/dengmengmian/agentgate-ai/releases/download/v1.4.1/AgentGate_1.4.1_aarch64.dmg) |
...
| 🐧 Linux — other distros | [AgentGate_1.4.1_amd64.AppImage](https://github.com/dengmengmian/agentgate-ai/releases/download/v1.4.1/AgentGate_1.4.1_amd64.AppImage) |
