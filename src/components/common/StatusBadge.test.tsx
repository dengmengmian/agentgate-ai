...
describe("StatusBadge", () => {
  ...
  it("applies muted styles", () => {
    const { container } = render(<StatusBadge variant="muted">Off</StatusBadge>);
    const badge = container.querySelector("span");
  ...
  it("applies accent styles", () => {
    const { container } = render(<StatusBadge variant="accent">Info</StatusBadge>);
    const badge = container.querySelector("span");
  ...
  it("merges custom className", () => {
    const { container } = render(
      <StatusBadge variant="success" className="custom-class">OK</StatusBadge>
    );
    const badge = container.querySelector("span");
