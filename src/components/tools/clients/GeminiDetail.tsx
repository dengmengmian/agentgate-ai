...
import type { GeminiCliConfigStatus } from "@/types/config";
import { DetailHeader, type T } from "@/pages/Tools";

export function GeminiDetail({
  status,
  onApply,
  onToggle,
  load,
    ...
    <div className="rounded-xl border border-border bg-card p-5">
      ...
      {status && (
        <div className="mb-4 grid grid-cols-2 gap-y-2 text-xs">
          <div>
            <span className="text-text-muted">settings.json</span>
