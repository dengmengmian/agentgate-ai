...
const translations: Record<string, Record<Locale, string>> = {
  ...
  "mcp.servers_across": { en: "servers across", zh: "个服务器，来自" },
  "mcp.clients": { en: "clients", zh: "个客户端" },
  "mcp.add_server": { en: "Add Server", zh: "添加服务器" },
  "mcp.no_servers": { en: "No MCP servers found", zh: "未发现 MCP 服务器" },
  "mcp.no_servers_hint": { en: "MCP servers from Claude Code and Gemini CLI will appear here.", zh: "Claude Code 和 Gemini CLI 中配置的 MCP 服务器会显示在这里。" },
  "mcp.server_disabled": { en: "Disabled", zh: "已禁用" },
  "mcp.enabled": { en: "Server enabled", zh: "服务器已启用" },
  "mcp.disabled": { en: "Server disabled", zh: "服务器已禁用" },
  "mcp.enable": { en: "Enable", zh: "启用" },
  "mcp.disable": { en: "Disable", zh: "禁用" },
  "mcp.server_added": { en: "Server added", zh: "服务器已添加" },
  "mcp.target_client": { en: "Target Client", zh: "目标客户端" },
  "mcp.server_name": { en: "Server Name", zh: "服务器名称" },
  "mcp.command": { en: "Command", zh: "命令" },
  "mcp.args": { en: "Arguments", zh: "参数" },
