...
const translations: Record<string, Record<Locale, string>> = {
  ...
  "dashboard.gateway_empty_title": {
    en: "Provider ready. Start the local gateway.",
    zh: "供应商已就绪，启动本地网关",
  },
  ...
  "dashboard.no_requests_ready_title": {
    en: "Ready for the first request",
    zh: "可以发起第一次请求了",
  },
  ...
  "dashboard.metrics.recent_requests": {
    en: "Recent Requests",
    zh: "最近请求",
  },
  "dashboard.metrics.tools_detected": {
    en: "Tools Detected",
    zh: "检测到的工具",
  },
  ...
  "providers.delete_warn": {
    en: "This action cannot be undone.",
    zh: "此操作无法撤销。",
  },
  "providers.no_providers": { en: "No providers", zh: "暂无供应商" },
  "providers.add_first": {
    en: "Add your first provider to get started",
    zh: "添加第一个供应商以开始使用",
  },
  ...
  "providers.auto_cache_hint_native": {
    ...
    zh: "自动注入 cache_control 实现 Anthropic prompt 缓存，缓存命中时输入成本降低约 90%。",
  },
  "providers.auto_cache_hint_compat": {
    en: "Inject cache_control for Anthropic-compatible endpoint. Whether caching works depends on upstream implementation. Check cache_read_tokens in request logs to verify.",
    zh: "为 Anthropic 兼容端点注入 cache_control。是否生效取决于上游实现，可通过请求日志的 cache_read_tokens 字段验证。",
  },
  ...
  "providers.traffic_status.no_traffic": {
    en: "No 24h traffic",
    zh: "24h 无请求",
  },
  "providers.traffic_status.unknown": { en: "Unknown", zh: "未知" },
  "providers.error_status.rate_limited": { en: "Rate limited", zh: "限流" },
  "providers.error_status.quota_exhausted": {
    en: "Quota exhausted",
    zh: "额度不足",
  },
  "providers.error_status.insufficient_balance": {
    en: "Low balance",
    zh: "余额不足",
  },
  ...
  "providers.search_placeholder": {
    en: "Filter providers...",
    zh: "筛选供应商...",
  },
  "providers.no_match": {
    en: "No providers match the filter.",
    zh: "没有匹配的供应商",
  },
  "providers.test.title": { en: "Testing provider", zh: "测试供应商" },
  "providers.test.step_connectivity": {
    en: "Connectivity & auth",
    zh: "连接 + 鉴权",
  },
  "providers.test.step_autofill": {
    en: "Capability matrix autofill",
    zh: "能力矩阵自动填充",
  },
  "providers.test.step_cache": {
    en: "Prompt cache detection",
    zh: "缓存支持检测",
  },
  "providers.test.autofill_n": {
    en: "Filled {n} models",
    zh: "识别 {n} 个模型能力",
  },
  "providers.test.autofill_none": { en: "No new entries", zh: "无新增条目" },
  "providers.test.cache_skipped_not_anthropic": {
    en: "Skipped (non-Anthropic provider)",
    zh: "已跳过（非 Anthropic 端点）",
  },
  ...
  "providers.hint_setup_failover": {
    en: "Set up failover chain?",
    zh: "顺手配下失败转移？",
  },
  ...
  "providers.supported_models_hint": {
    en: "Save first, then click Fetch Models to auto-detect.",
    zh: "先保存，然后点击「获取模型」自动检测。",
  },
  "providers.fetch_models": { en: "Fetch Models", zh: "获取模型" },
  "providers.fetch_models_hint": {
    en: "Click Fetch Models to load from provider.",
    zh: "点击「获取模型」从供应商加载。",
  },
  "providers.fetch_and_detect": { en: "Fetch & detect", zh: "拉取并识别能力" },
  "providers.models_and_caps": {
    en: "Models & Capabilities",
    zh: "模型与能力",
  },
  "providers.toast_models_and_caps": {
    en: "models · caps detected",
    zh: "个模型，能力已自动识别",
  },
  "providers.toast_auto_setup": {
    en: "models auto-configured",
    zh: "个模型已自动配置（默认/推理已选最新）",
  },
  "providers.cap_matrix_toggle": {
    en: "Capability matrix (advanced)",
    zh: "能力矩阵（高级）",
  },
  "providers.cap_matrix_hint": {
    en: "Tweak per-model capability flags. The gateway uses these to route requests with images/audio to the right model.",
    zh: "微调每个模型的能力。请求带图片/音频时网关会自动路由到匹配的模型。",
  },
  "providers.ctx_window_col": { en: "Context window", zh: "上下文窗口" },
  "providers.ctx_window_hint": {
    en: "Per-model context window (tokens) for auto-compaction threshold. Leave empty to use the built-in catalog, falling back to 110000.",
    zh: "每个模型的上下文窗口(token),用于自压缩阈值。留空走内置 catalog,再退回 110000。",
  },
  "providers.base_url_custom_hint": {
    en: "Required for custom providers.",
    zh: "Custom 类型必须填写。",
  },
  "providers.advanced_hint": {
    en: "Usually no need to touch",
    zh: "通常无需修改",
  },
  "providers.endpoints": {
    en: "Native Protocol Endpoints",
    zh: "上游原生协议入口",
  },
  ...
  "providers.model_mapping_hint": {
    en: "Map client model names (e.g. gpt-5.5, claude-sonnet-4-7) to provider models.",
  ...
  "providers.pass_through_tooltip": {
    en: "The upstream natively supports this API. Matching client requests are forwarded without protocol translation; Model Mapping may still rename the model.",
    zh: "上游原生支持该 API。客户端协议匹配时不做协议转换；如命中模型映射，模型名仍会按映射改写。",
  },
  "providers.select_client_model": {
    en: "Select client model...",
    zh: "选择客户端模型...",
  },
  ...
  "providers.anthropic_url_hint": {
    en: "Anthropic Messages API endpoint for Claude Code pass-through (e.g. https://api.deepseek.com/anthropic)",
    zh: "Anthropic Messages API 端点，用于 Claude Code 直通转发（如 https://api.deepseek.com/anthropic）",
  },
  "providers.responses_url": {
    en: "Responses API Endpoint",
    zh: "Responses API 端点",
  },
  "providers.responses_url_hint": {
    en: "Pass-through endpoint for Responses API (e.g. https://api.openai.com). Leave empty to use transform.",
    zh: "Responses API 透传端点（如 https://api.openai.com）。留空则走转换。",
  },
  "providers.extra_headers": { en: "Extra Headers", zh: "额外请求头" },
  "providers.extra_headers_hint": {
    en: 'JSON object of custom headers, e.g. {"User-Agent":"KimiCLI/1.40.0"}',
    zh: '自定义请求头 JSON 对象，如 {"User-Agent":"KimiCLI/1.40.0"}',
  },
  "providers.quick_add_hint": {
    en: "Paste your API Key to auto-detect provider",
    zh: "粘贴 API Key 自动识别供应商",
  },
  "providers.quick_add_unknown": {
    en: "Provider not recognized. Select it manually to continue.",
    zh: "未识别到供应商，手动选择后即可继续。",
  },
  ...
  "providers.protocol_hint": {
    en: "Auto-set by provider type. Change only if provider natively supports a different protocol (e.g. OpenAI Responses for transparent proxy).",
    zh: "根据供应商类型自动设置。仅在 Provider 原生支持不同协议时修改（如选择 OpenAI Responses 走透明代理）。",
  },
  ...
  "providers.detail.empty_models": {
    en: "No model-level gateway traffic yet.",
    zh: "暂无模型维度网关请求。",
  },
  "providers.detail.empty_errors": {
    en: "No recent errors.",
    zh: "暂无最近错误。",
  },
  ...
  "gateway.settings_changed": {
    en: "Unsaved changes. Click Save first.",
    zh: "有未保存的更改，请先点保存。",
  },
  "gateway.restart_required_title": {
    en: "Saved settings differ from running gateway",
    zh: "保存的设置与运行中的网关不一致",
  },
  ...
  "gateway.settings_saved": {
    en: "Gateway settings saved",
    zh: "网关设置已保存",
  },
  "gateway.invalid_port": {
    en: "Invalid port (1-65535)",
    zh: "端口无效（1-65535）",
  },
  "gateway.invalid_retention": {
    en: "Invalid retention days",
    zh: "保留天数无效",
  },
  ...
  "gateway.deepseek_cleaner": {
    en: "DeepSeek schema cleaner",
    zh: "DeepSeek 清理",
  },
  ...
  "logs.clear_msg": {
    en: "This will permanently delete all request logs. This action cannot be undone.",
    zh: "将永久删除所有请求日志。此操作无法撤销。",
  },
  "logs.clear_confirm": { en: "Clear All", zh: "全部清除" },
  "logs.cleared": { en: "Logs cleared", zh: "日志已清除" },
  "logs.no_logs": { en: "No request logs", zh: "暂无请求日志" },
  "logs.no_logs_desc": {
    en: "Logs will appear here once the gateway processes requests",
    zh: "网关处理请求后，日志将显示在此处",
  },
  ...
  "logs.filter_route_profile": {
    en: "Filter by route profile",
    zh: "按路由策略筛选",
  },
  "logs.filter_error_type": {
    en: "Filter by error type",
    zh: "按错误类型筛选",
  },
  ...
  "logs.error_type.quota_or_balance": {
    en: "Quota / balance",
    zh: "额度 / 余额",
  },
  ...
  "tools.claude_code_desc": {
    en: "Anthropic's CLI for Claude",
    zh: "Anthropic 的 Claude 命令行工具",
  },
  ...
  "tools.opencode_desc": {
    en: "Open-source terminal AI coding assistant",
    zh: "开源终端 AI 编程助手",
  },
  ...
  "tools.gemini_cli_desc": {
    en: "Google's AI coding CLI with Gemini API support.",
    zh: "Google AI 编程 CLI，支持 Gemini API。",
  },
  "tools.gemini_cli_notice_title": {
    en: "Gemini CLI uses Google native API format, protocol conversion not supported yet",
  ...
  "tools.atomcode_desc": {
    en: "Open-source AI coding agent in your terminal.",
    zh: "开源终端 AI 编程 Agent。",
  },
  ...
  "tools.gateway_not_running_hint": {
    ...
    zh: "网关未启动。启动前客户端会显示网络连接失败。",
  },
  "tools.config_written": { en: "config written to", zh: "配置已写入" },
  "tools.post_apply.title": {
    en: "Applied {name} config",
    zh: "{name} 配置已应用",
  },
  ...
  "tools.history.action.apply_template": {
    en: "Apply template",
    zh: "应用模板",
  },
  "tools.history.rollback": { en: "Roll back", zh: "回滚" },
  "tools.history.confirm_title": {
    en: "Roll back this snapshot?",
    zh: "回滚到该版本？",
  },
  ...
  "instructions.scope.claude": {
    en: "Claude (~/.claude/CLAUDE.md)",
    zh: "Claude（~/.claude/CLAUDE.md）",
  },
  "instructions.scope.codex": {
    en: "Codex (~/.codex/AGENTS.md)",
    zh: "Codex（~/.codex/AGENTS.md）",
  },
  "instructions.file_status.exists": {
    en: "{size} bytes on disk",
    zh: "磁盘上 {size} 字节",
  },
  "instructions.file_status.missing": {
    en: "Not created yet — will be created on save.",
    zh: "尚未创建，保存时会自动建立。",
  },
  ...
  "instructions.templates.empty": {
    en: "No templates available for this scope.",
    zh: "当前 scope 暂无可用模板。",
  },
  "instructions.confirm_overwrite_title": {
    en: "Overwrite current file?",
    zh: "覆盖当前文件？",
  },
  ...
  "instructions.backup.exported": {
    en: "Instructions exported",
    zh: "指令已导出",
  },
  "instructions.backup.imported": {
    en: "Instructions restored",
    zh: "指令已恢复",
  },
  ...
  "instructions.backup.paste": {
    en: "Paste instructions backup JSON",
    zh: "粘贴指令备份 JSON",
  },
  ...
  "skills.imported_backup": {
    en: "Restored {count} skill(s)",
    zh: "已恢复 {count} 个技能",
  },
  "skills.import_backup_none": {
    en: "Nothing imported (all already exist)",
    zh: "没有导入（目标已存在）",
  },
  "skills.paste_backup": {
    en: "Paste skills backup JSON",
    zh: "粘贴技能备份 JSON",
  },
  "skills.skipped_note": {
  ...
  "routes.auto_created": {
    en: "Route profiles will be created automatically",
    zh: "路由配置将自动创建",
  },
  ...
  "routes.default_profile": {
    en: "Default for this protocol",
    zh: "此协议的默认策略",
  },
  "routes.custom_profile": { en: "Custom route profile", zh: "自定义策略" },
  "routes.failover_hint": {
    en: "Try candidates until one succeeds",
    zh: "失败后继续尝试备用供应商",
  },
  "routes.manual_hint": {
    en: "Always use the active provider",
    zh: "始终使用主供应商",
  },
  "routes.primary_hint": {
    en: "Used first for this route",
    zh: "此策略优先使用",
  },
  "routes.fallback_hint": {
    en: "Backup providers are available",
    zh: "已有备用供应商",
  },
  "routes.no_fallback_hint": {
    en: "Manual mode has no fallback",
    zh: "固定模式不做失败转移",
  },
  ...
  "routes.conditions_hint": {
    en: "Use this provider only for matching requests. Leave empty to keep it always available.",
    zh: "仅在这些请求使用此供应商。留空表示始终可用。",
  },
  "routes.conditions_protocol_note": {
    en: "Some conditions are only detected reliably on the OpenAI Responses route.",
    zh: "部分条件只在 OpenAI Responses 路由下能稳定识别。",
  },
  ...
  "routes.system_keywords": {
    en: "System Prompt Keywords",
    zh: "系统提示词关键词",
  },
  "routes.keywords_hint": {
    en: "Comma-separated. Match if system prompt contains ANY keyword.",
    zh: "逗号分隔。系统提示词包含任一关键词即匹配。",
  },
  "routes.condition_model_override": {
    en: "Model Override (when matched)",
    zh: "模型覆盖（条件匹配时使用此模型）",
  },
  "routes.model_override_hint": {
    en: "Optional. Use a different model when this condition matches.",
    zh: "可选。条件匹配时使用指定模型替代默认模型。",
  },
  "routes.scene_none": {
    en: "No Condition (default)",
    zh: "无条件（默认兜底）",
  },
  "routes.scene_images": { en: "Image Requests", zh: "图片请求" },
  "routes.scene_reasoning": {
    en: "Reasoning / Thinking",
    zh: "推理 / 深度思考",
  },
  "routes.scene_background": {
    en: "Background / Subtask",
    zh: "后台 / 子任务",
  },
  "routes.scene_long_text": {
    en: "Long Text (>100K chars)",
    zh: "长文本（>100K 字符）",
  },
  ...
  "routes.hide_advanced_conditions": {
    en: "Hide advanced rules",
    zh: "收起高级规则",
  },
  ...
  "routes.active_updated": {
    en: "Active provider updated",
    zh: "活跃供应商已更新",
  },
  "routes.provider_added": {
    en: "Provider added to route",
    zh: "供应商已添加到路由",
  },
  ...
  "routes.strategy_hint": {
    en: "Failover candidate order: by priority / cheapest unit price / fastest recent latency",
    zh: "故障转移候选顺序：按优先级 / 单价最低 / 近期延迟最快",
  },
  ...
  "settings.open_token_folder": {
    en: "Open Token Folder",
    zh: "打开令牌文件夹",
  },
  "settings.regen_title": {
    en: "Regenerate Access Token",
    zh: "重新生成访问令牌",
  },
  "settings.regen_msg": {
    en: "Regenerating the token will invalidate existing tool configurations. Codex uses command auth and reads the token file automatically. You must re-apply Claude Code config after regeneration.",
    zh: "重新生成令牌将使现有工具配置失效。Codex 使用命令认证，会自动读取令牌文件。重新生成后必须重新应用 Claude Code 配置。",
  },
  "settings.regen_done": {
    en: "Token regenerated. Re-apply Claude Code config (Codex uses command auth and updates automatically).",
  ...
  "settings.auto_start_desc": {
    en: "Start the local gateway on app launch",
    zh: "应用启动时自动启动本地网关",
  },
  ...
  "settings.log_retention_desc": {
    en: "How long to keep request logs",
    zh: "请求日志保留时长",
  },
  "settings.model_pricing": { en: "Model Pricing", zh: "模型价格" },
  "settings.model_pricing_desc": {
    en: "Cost is calculated per request based on token usage × price. Built-in defaults cover major models. Add custom prices to override.",
    zh: "费用按每次请求的 token 用量 × 价格计算。内置默认价格覆盖主流模型，可添加自定义价格覆盖。",
  },
  ...
  "settings.show_quick_setup_desc": {
    en: "Show Quick Setup entry in sidebar",
    zh: "在侧边栏显示快速配置入口",
  },
  ...
  "settings.pet.desc": {
    en: "A floating pet on your desktop that reacts to gateway activity",
    zh: "浮动在桌面上的宠物，可随网关活动做出反应",
  },
  "settings.pet.visible": { en: "Show Pet", zh: "显示宠物" },
  "settings.pet.visible_desc": {
    en: "Show or hide the desktop pet",
    zh: "显示或隐藏桌面宠物",
  },
  "settings.pet.click_through": { en: "Click-through", zh: "鼠标穿透" },
  "settings.pet.click_through_desc": {
    en: "When on, clicks pass through the pet window to the app below. The in-pet menu can't be clicked in this mode — use this toggle to recover.",
    zh: "开启后点击会穿过宠物窗口到下方应用。此时右键菜单点不到——用这个开关恢复。",
  },
  "settings.pet.type": { en: "Pet Type", zh: "宠物类型" },
  "settings.pet.type_desc": {
    en: "Choose your desktop companion",
    zh: "选择你的桌面伙伴",
  },
  "settings.pet.robot": { en: "Gateway Bot", zh: "网关机器人" },
  "settings.pet.robot_desc": {
    en: "A little robot with gateway arrows on its chest",
    zh: "胸口带网关箭头的小机器人",
  },
  "settings.pet.pixel-cat": { en: "Pixel Cat", zh: "像素猫" },
  "settings.pet.pixel-cat_desc": {
    en: "A cute pixel-art cat with wagging tail",
    zh: "一只会摇尾巴的像素风猫咪",
  },
  "settings.pet.slime": { en: "Slime", zh: "史莱姆" },
  "settings.pet.slime_desc": {
    en: "A bouncy jelly blob with expressive eyes",
    zh: "一团有表情的弹性果冻",
  },
  "settings.pet.fox": { en: "CEO", zh: "CEO" },
  "settings.pet.fox_desc": {
    en: "The boss with a golden tie, always watching",
    zh: "戴金色领带的老板，时刻关注着一切",
  },
  "settings.pet.octopus": { en: "Octopus", zh: "章鱼" },
  "settings.pet.octopus_desc": {
    en: "A purple octopus with waving tentacles",
    zh: "一只触手摇摆的紫色章鱼",
  },
  "settings.pet.ghost": { en: "MaFan", zh: "麻凡" },
  "settings.pet.ghost_desc": {
    en: "A friendly ghost who floats around",
    zh: "一个飘来飘去的友好幽灵",
  },
  "settings.pet.soldier": { en: "FenZong", zh: "分总" },
  "settings.pet.soldier_desc": {
    en: "A super soldier in full armor, unstoppable",
    zh: "全副武装的超级兵，势不可挡",
  },
  "settings.pet.coder": { en: "ZhenZhen", zh: "振振" },
  "settings.pet.coder_desc": {
    en: "A reliable core developer, coffee & commits",
    zh: "老实靠谱的核心程序员，咖啡与commit",
  },
  "settings.pet.ox": { en: "KuiKui", zh: "奎奎" },
  "settings.pet.ox_desc": {
    en: "A hardworking ox that never stops",
    zh: "一头永不停歇的牛马打工人",
  },
  ...
  "onboarding.provider_select_placeholder": {
    en: "Select provider...",
    zh: "选择供应商...",
  },
  ...
  "onboarding.select_tools_desc": {
    en: "Choose which coding tools to configure",
    zh: "选择要配置的编程工具",
  },
  ...
  "onboarding.detecting_capabilities": {
    en: "Fetching models & detecting capabilities",
    zh: "拉取模型并识别能力",
  },
  ...
  "mcp.subtitle_after": {
    en: ". env shows keys only, not values.",
    zh: "。env 仅显示 key，不显示值。",
  },
  "mcp.add_server": { en: "Add server", zh: "添加 server" },
  "mcp.more": { en: "More", zh: "更多" },
  "mcp.export_include_secrets": {
    en: "Include secrets in export",
    zh: "导出包含密钥",
  },
  ...
  "mcp.search_placeholder": {
    en: "Search name / command / env",
    zh: "搜索 name / command / env",
  },
  "mcp.export_config": { en: "Export MCP config", zh: "导出 MCP 配置" },
  "mcp.import_config": { en: "Import MCP config", zh: "导入 MCP 配置" },
  "mcp.export_hint_with_value": {
    en: "Current export includes env values.",
    zh: "当前导出包含 env value。",
  },
  "mcp.export_hint_hidden": {
    en: "Current export hides env values.",
    zh: "当前导出已隐藏 env value。",
  },
  "mcp.import_hint": {
    en: "Paste JSON, then choose a target client.",
    zh: "粘贴 JSON 后选择目标客户端。",
  },
  "mcp.import": { en: "Import", zh: "导入" },
  "mcp.export_result_placeholder": {
    en: "Export result will appear here",
    zh: "导出结果会显示在这里",
  },
  "mcp.import_paste_placeholder": {
    en: "Paste MCP export JSON",
    zh: "粘贴 MCP 导出 JSON",
  },
  "mcp.empty_title": {
    en: "No MCP servers detected",
    zh: "没有检测到 MCP 服务器",
  },
  "mcp.empty_desc": {
    en: "Once you configure an MCP server in Codex or Claude Code, it will be listed here automatically.",
    zh: "在 Codex 或 Claude Code 里配置过 MCP server 后，这里会自动列出。",
  },
  "mcp.server": { en: "MCP server", zh: "MCP server" },
  "mcp.edit_server": { en: "Edit MCP server", zh: "编辑 MCP server" },
  "mcp.no_match": {
    en: "No matching MCP server.",
    zh: "没有匹配的 MCP server。",
  },
  ...
  "mcp.field_env": {
    en: "env (KEY=value; leave value empty when editing to keep the original)",
    zh: "env（KEY=value，编辑时 value 留空会保留原值）",
  },
  "mcp.missing": { en: "missing", zh: "缺失" },
  "mcp.name_command_required": {
    en: "name and command are required",
    zh: "name 和 command 必填",
  },
  ...
  "mcp.sync_confirm": {
    en: "Sync {name} to {target}? Configs with the same name will be overwritten.",
    zh: "同步 {name} 到 {target}？同名配置会被覆盖。",
  },
  "mcp.synced_to": { en: "Synced to {target}", zh: "已同步到 {target}" },
  "mcp.export_secrets_confirm": {
    en: "Export will include env values. Continue?",
    zh: "导出会包含 env value，确认继续？",
  },
  "mcp.exported": { en: "MCP config exported", zh: "已导出 MCP 配置" },
  "mcp.exported_with_secrets": {
    en: "MCP config exported (with secrets)",
    zh: "已导出 MCP 配置（含密钥）",
  },
  "mcp.paste_json_required": {
    en: "Please paste the MCP export JSON",
    zh: "请粘贴 MCP 导出 JSON",
  },
  "mcp.import_confirm": {
    en: "Import to {target}? Configs with the same name will be overwritten.",
    zh: "导入到 {target}？同名配置会被覆盖。",
  },
  ...
  "logs.summary_page_success_rate": {
    en: "Page success rate",
    zh: "本页成功率",
  },
  "logs.summary_page_avg_latency": {
    en: "Page avg latency",
    zh: "本页平均延迟",
  },
  ...
  "logs.filter_source": {
    en: "Filter by source: gateway / client local logs",
    zh: "按来源过滤：网关 / 各客户端本地日志",
  },
  "logs.all_sources": { en: "All sources", zh: "全部来源" },
  "logs.source_session_log": {
    en: "Client logs (all)",
    zh: "客户端日志（全部）",
  },
  ...
  "logs.view_session_hint": {
    en: "Aggregate usage by session",
    zh: "按会话聚合用量",
  },
  ...
  "logs.sync_claude_hint": {
    en: "Scan session logs under ~/.claude/projects/ to backfill usage from Claude Code used outside the gateway",
    zh: "扫描 ~/.claude/projects/ 下的会话日志，补齐绕过网关使用 Claude Code 时的用量记录",
  },
  "logs.sync_codex_hint": {
    en: "Scan session logs under ~/.codex/sessions/ to backfill usage from Codex used outside the gateway",
    zh: "扫描 ~/.codex/sessions/ 下的会话日志，补齐绕过网关使用 Codex 时的用量记录",
  },
  "logs.sync_gemini_hint": {
    en: "Scan session logs under ~/.gemini/tmp/ to backfill usage from Gemini CLI used outside the gateway",
    zh: "扫描 ~/.gemini/tmp/ 下的会话日志，补齐绕过网关使用 Gemini CLI 时的用量记录",
  },
  "logs.sync_claude_missing": {
    en: "Claude Code session directory not found (~/.claude/projects/)",
    zh: "未找到 Claude Code 会话目录（~/.claude/projects/）",
  },
  "logs.sync_codex_missing": {
    en: "Codex session directory not found (~/.codex/sessions/)",
    zh: "未找到 Codex 会话目录（~/.codex/sessions/）",
  },
  "logs.sync_gemini_missing": {
    en: "Gemini CLI session directory not found (~/.gemini/tmp/)",
    zh: "未找到 Gemini CLI 会话目录（~/.gemini/tmp/）",
  },
  ...
  "logs.session_delete_msg": {
    en: "This deletes the session's usage records and the local Claude / Codex log files. The client cannot recover the session afterward, and this cannot be undone.",
    zh: "将删除该会话的统计记录，并删除 Claude / Codex 的本地日志文件。删除后客户端无法再恢复该会话，且不可撤销。",
  },
  ...
  "logs.view_session_convo": {
    en: "View session conversation",
    zh: "查看会话对话",
  },
  "logs.route_and_cost": { en: "Trace & Cost", zh: "链路与成本" },
  "logs.conversation_title": { en: "Session conversation", zh: "会话对话" },
  "logs.conversation_empty": {
    en: "No conversation content to display (this source's local log may not include the full conversation).",
    zh: "没有可显示的对话内容（该来源的本地日志可能不含完整对话）。",
  },
  "logs.resume_cmd_copied": {
    en: "Resume command copied",
    zh: "已复制恢复命令",
  },
  ...
  "logs.suggest_balance": {
    en: "Account balance is insufficient or quota exhausted. Top up or raise the quota in the provider's console.",
    zh: "账户余额不足或额度耗尽。去 provider 后台充值或提升配额。",
  },
  "logs.suggest_auth": {
    en: "The API key is invalid, expired, or lacks permission. Go back to the providers page, edit this provider, and paste the key again.",
    zh: "API key 无效、过期或权限不足。回供应商页编辑该 provider，重新粘贴 key。",
  },
  "logs.suggest_rate_limit": {
    en: "Upstream rate limit hit. Lower the request rate, or configure multiple providers in the route profile for failover.",
    zh: "上游限频。降低请求频率，或在路由策略里配多个 provider 做失败转移。",
  },
  "logs.suggest_context_length": {
    en: "Request exceeds the model's context / max_tokens limit. Shorten the prompt, raise max_output_tokens, or switch to a model with a larger window.",
    zh: "请求超出 model 上下文 / max_tokens 限制。缩短 prompt、调高 max_output_tokens，或换更大窗口的模型。",
  },
  "logs.suggest_upstream_5xx": {
    en: "Upstream service is temporarily down (5xx). Retry once now, or add failover in the route profile for automatic switching.",
    zh: "上游服务临时故障（5xx）。立刻重试一次，或在路由策略里加 failover 自动切换。",
  },
  "logs.suggest_upstream_html": {
    en: "The upstream gateway returned an HTML error page (usually a connection blip between the upstream and its origin). Retry now or switch provider.",
    zh: "上游网关返回了 HTML 错误页（通常是上游内部到 origin 的连接抖动）。立刻重试或切换 provider。",
  },
  "logs.suggest_upstream_500": {
    en: "Upstream internal error. Retry once first; if it keeps failing, check the provider's status page.",
    zh: "上游内部错误。先重试一次；持续失败检查 provider 状态页。",
  },
  "logs.suggest_network": {
    en: "Network issue. Check your local network / VPN / whether a proxy is needed to reach this provider.",
    zh: "网络问题。检查本机网络 / VPN / 是否需要代理访问该供应商。",
  },
  "logs.suggest_bad_request": {
    en: "The provider rejected the request (400). Check the raw response below for the specific field; you may need to adjust the model or parameters in the provider config.",
    zh: "请求被供应商拒绝（400）。看下面的「原始响应」找具体字段名，可能需要在 provider 配置里调整 model 或参数。",
  },
  "logs.suggest_not_found": {
    en: "Upstream path not found. Check whether the provider's base_url is correct and whether it needs a /v1 suffix.",
    zh: "上游路径不存在。检查 provider 的 base_url 是否正确、是否需要 /v1 后缀。",
  },

  // ── Settings: refiner + config backup ──
  "settings.refiner": { en: "Gateway Refiner", zh: "网关精炼层 (Refiner)" },
  "settings.refiner_desc": {
    en: "Off by default — the gateway forwards requests as-is. When on, requests/responses are rewritten per each provider's quirks config. Each provider can still force-disable individually.",
    zh: "默认全部关闭，网关原样转发请求。打开后会按每个 provider 的 quirks 配置改写请求 / 响应。每个 provider 还能单独覆写为强制关。",
  },
  "settings.body_filter": { en: "Request field filtering", zh: "请求字段过滤" },
  "settings.body_filter_desc": {
    en: "Strip unsupported request fields per Quirks to avoid 400 errors",
    zh: "按 Quirks 剥不支持的请求字段，避免 400 错误",
  },
  "settings.thinking_rectifier": {
    en: "Reasoning param correction",
    zh: "推理参数校正",
  },
  "settings.thinking_rectifier_desc": {
    en: "Auto-normalize thinking.budget_tokens / reasoning.effort",
    zh: "thinking.budget_tokens / reasoning.effort 自动归一",
  },
  "settings.error_mapper": {
    en: "Error response normalization",
    zh: "错误响应归一",
  },
  "settings.error_mapper_desc": {
    en: "Rewrite provider error structures into the shape the client protocol expects",
    zh: "provider 错误结构改写成客户端协议期望的形态",
  },
  ...
  "settings.config_backup_desc_1": {
    en: "Export providers + route profiles to a JSON file for migrating machines or backup. Import will ",
    zh: "导出 providers + route profiles 为 JSON 文件，方便迁移机器或备份后再恢复。导入会",
  },
  "settings.config_backup_replace": { en: "replace", zh: "替换" },
  "settings.config_backup_desc_2": {
    en: " all current config (request logs, pricing and other history are not affected).",
    zh: "当前所有配置（请求日志、定价等历史数据不受影响）。",
  },
  "settings.include_secrets": {
    en: "Include API keys in export (for local migration only; do not share the exported file)",
    zh: "导出时包含 API key（仅用于本机迁移；导出文件请勿分享）",
  },
  ...
  "settings.import_share_code_hint": {
    en: "Or paste a share code from someone else to import (no secrets; you'll need to fill in API keys after import):",
    zh: "或者粘贴别人发来的分享码导入（不含密钥，导入后需自己填 API key）：",
  },
  "settings.share_code_placeholder": {
    en: "Paste share code…",
    zh: "粘贴分享码…",
  },
  "settings.import": { en: "Import", zh: "导入" },
  "settings.import_confirm_title": {
    en: "Confirm config import?",
    zh: "确认导入配置？",
  },
  "settings.import_confirm_msg": {
    en: "Import will clear all current providers and route profiles and restore from the file. This cannot be undone — export your current config as a backup first.",
    zh: "导入会清空当前所有 providers 和 route profiles，并从文件还原。操作不可撤销——建议先导出当前配置作为备份。",
  },
  "settings.importing": { en: "Importing...", zh: "导入中..." },
  "settings.import_confirm": { en: "Confirm Import", zh: "确认导入" },
  "settings.exported_with_secrets": {
    en: "Exported (with secrets)",
    zh: "已导出（含密钥）",
  },
  "settings.exported_no_secrets": {
    en: "Exported (no secrets)",
    zh: "已导出（不含密钥）",
  },
  "settings.share_code_copied": {
    en: "Share code copied (no secrets) — send it for the other side to paste and import",
    zh: "已复制分享码（不含密钥），发给对方粘贴导入即可",
  },
  "settings.share_code_invalid": {
    en: "Share code is invalid or corrupted",
    zh: "分享码无效或已损坏",
  },
  "settings.import_invalid_json": {
  ...
  "settings.imported_route_profiles": {
    en: "route profile(s)",
    zh: "个 route profile",
  },
  "settings.imported_with_secrets": { en: " (with secrets)", zh: "（含密钥）" },
  "settings.imported_no_secrets": {
    en: " (re-enter secrets)",
    zh: "（密钥需重新填写）",
  },
  ...
  "providers.speedtest_desc_1": {
    en: "Sends one",
    zh: "对每个启用的 provider 并行发送一个",
  },
  "providers.speedtest_desc_2": {
    en: "probe request to each enabled provider in parallel, recording connect, TTFB and total latency.",
    zh: "的探测请求，记录连接、TTFB、总耗时。",
  },
  "providers.speedtest_desc_cost": {
    en: "Each run consumes a small amount of tokens",
    zh: "每次运行都会消耗少量 token",
  },
  "providers.speedtest_desc_3": {
    en: ", and is never triggered automatically.",
    zh: "，不会自动触发。",
  },
  ...
  "providers.speedtest_no_enabled": {
    en: "No enabled providers to test",
    zh: "没有启用的 provider 可测速",
  },
  "providers.speedtest_col_status": { en: "Status", zh: "状态" },
  "providers.speedtest_error_hint": {
    en: "Hover the red icon to see error details.",
    zh: "鼠标悬停红色感叹号查看错误详情。",
  },
  "providers.speedtest_button": { en: "Speedtest", zh: "测速" },
  "providers.speedtest_button_tooltip": {
    en: "Send probe requests to all enabled providers in parallel and record latency",
    zh: "对所有启用的 provider 并行发探测请求，记录延迟",
  },
  ...
  "tools.claude_desktop_not_detected": {
    en: "Claude Desktop not detected.",
    zh: "未检测到 Claude Desktop。",
  },
  "tools.claude_desktop_profile_label": {
    en: "Config file (3p profile)",
    zh: "配置文件（3p profile）",
  },
  "tools.claude_desktop_restart_hint": {
    en: "Restart Claude Desktop after applying for it to take effect. To revert, use the history rollback above.",
    zh: "应用后请重启 Claude Desktop 生效。要还原，用上面的历史回滚。",
  },
  ...
  "tools.drift_count_hint": {
    en: "config(s) changed, re-apply recommended",
    zh: "个配置已变，建议重新应用",
  },
  "tools.drifted_label": {
    en: "Config changed · re-apply",
    zh: "配置已变·重新应用",
  },
