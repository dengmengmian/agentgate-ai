...
const translations: Record<string, Record<Locale, string>> = {
  ...
  "providers.test.title": { en: "Testing provider", zh: "测试服务商" },
  ...
  "providers.quick_add_hint": { en: "Paste your API Key to auto-detect provider", zh: "粘贴 API Key 自动识别服务商" },
  "providers.quick_add_unknown": { en: "Provider not recognized. Use manual setup below.", zh: "未识别到服务商，请使用手动设置。" },
  ...
  "tools.step_provider": { en: "Provider", zh: "服务商" },
  ...
  "routes.conditions_hint": { en: "Set conditions for when this provider should be used. All conditions must match (AND). Leave empty for unconditional (always available).", zh: "设置使用此服务商的条件。所有条件必须同时满足（AND）。留空表示无条件（始终可用）。" },
